...
export const DUMMY_CHATS_POOL = [
  {
    name: "Nekomata 🐾",
    msg: "Semangat belajarnya!! Let's go~ ✨",
    color: "#ff9ecd",
  },
  {
    name: "SkyBlue 🌌",
    msg: "Pomodoro-nya sisa bentar lagi gan 🔥",
    color: "#87ceeb",
  },
  {
    name: "Pochi_kun 🐶",
    msg: "Lofi nya enak banget buat fokus www",
    color: "#ffd700",
  },
  {
    name: "Anon_123 ☕",
    msg: "Otsukare~ jangan lupa minum air 🥤",
    color: "#98fb98",
  },
  { name: "Kusa_ 草", msg: "Fokus fokus! PR siap kelar 💪", color: "#ffa07a" },
  {
    name: "Sakura_M 🌸",
    msg: "Sesi pomodoro ke-3 hari ini! Mantap",
    color: "#f472b6",
  },
  {
    name: "HoloFan 🎧",
    msg: "Bg music lofi-nya calming parah 🎧",
    color: "#c084fc",
  },
  {
    name: "ZatsudanLover",
    msg: "Senpai, jangan lupa regangkan bahu ya!",
    color: "#38bdf8",
  },
  {
    name: "MidnightCoder",
    msg: "Selesai 1 modul coding malam ini 💻✨",
    color: "#a78bfa",
  },
]
